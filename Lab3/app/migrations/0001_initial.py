# Generated by Django 4.2.7 on 2024-10-29 08:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(default=datetime.datetime(2024, 10, 29, 8, 59, 16, 875555, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
                ...
                ('moderator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='moderator', to=settings.AUTH_USER_MODEL, verbose_name='Оператор')),
